"""CORS controls with origin validation and logging."""
...
class SecureCORSMiddleware(MiddlewareMixin):
    """CORS middleware with origin allowlists and patterns."""
    ...
    def process_request(self, request):
        """Validate CORS requests and handle preflight."""
    ...
    def _should_allow_credentials(self, origin: str) -> bool:
        """Whether credentials are allowed for this origin."""
